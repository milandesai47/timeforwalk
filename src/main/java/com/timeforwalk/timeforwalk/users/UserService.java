...
import com.timeforwalk.timeforwalk.email.EmailSender;
import com.timeforwalk.timeforwalk.exception.BadRequestException;
import com.timeforwalk.timeforwalk.token.Token;
import com.timeforwalk.timeforwalk.token.TokenConfirmationService;
...
public class UserService {
  ...
  public void addUser(Users user) {
    ...
    tokenConfirmationService.saveToken(confirmationToken);
  ...
  public String confirmToken(String token) {
    Token confirmationToken = tokenConfirmationService
        .getToken(token)
        .orElseThrow(() ->
